...
*This PRD template was automatically generated when creating your wise-parrot-play app. Please customize it based on your specific requirements using the Deep Mode PRD flow in SnapDev.*
